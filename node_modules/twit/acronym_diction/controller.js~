...
function postTweet(acronym) {
    ...
    fs.appendFile("acronym_dictionary_log", "ACRONYM: " + acronym);

    console.log("acronym length: "+ acronym.length);
                ...
                if (hasLetter == false) {
                    for (word in wordLink)
                        if (word[0] == letter) {
                            ...
                            /*
                            if (i == acronym.length - 1) {
                                if (!isDeadLastWord(word) && !isDeadWord(word))
...
function printWordOptions(text, letter, options) {
    ...
    if (text == "first" || text == "empty") {
        ...
        console.log(msg);
        fs.appendFile("acronym_dictionary_log", msg);
    } else {
        if (options.length > 7) {
